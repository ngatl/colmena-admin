...
import { SystemUserApi } from '../../../../../packages/admin-lb-sdk'
...
export class AuthEffects {
  ...
  login: Observable<UnsafeAction> = this.actions$.ofType(auth.ActionTypes.AUTH_LOGIN).do((action: UnsafeAction) => {
  ...
  // @Effect({ dispatch: false })
  // loginError: Observable<UnsafeAction> = this.actions$.ofType(auth.ActionTypes.AUTH_LOGIN_ERROR).do((action: UnsafeAction) =>
  ...
  //
  @Effect({ dispatch: false })
  loginSuccess: Observable<UnsafeAction> = this.actions$.ofType(auth.ActionTypes.AUTH_LOGIN_SUCCESS).do((action: UnsafeAction) => {
  ...
  //
  // @Effect({ dispatch: false })
  // register: Observable<UnsafeAction> = this.actions$.ofType(auth.ActionTypes.AUTH_REGISTER).do((action: any) => {
  ...
  //
  // @Effect({ dispatch: false })
  // registerSuccess: Observable<UnsafeAction> = this.actions$
  ...
  //
  // @Effect({ dispatch: false })
  // registerError: Observable<UnsafeAction> = this.actions$.ofType(auth.ActionTypes.AUTH_REGISTER_ERROR).do((action: UnsafeAction) =>
  //   this.ui.alerts.notifyError({
  //     title: get(action, 'payload.name'),
  //     body: get(action, 'payload.message'),
  //   })
  ...
  //
  // @Effect({ dispatch: false })
  // logout: Observable<UnsafeAction> = this.actions$.ofType(auth.ActionTypes.AUTH_LOGOUT).do(() => {
  ...
  //
  // @Effect({ dispatch: false })
  // logoutError: Observable<UnsafeAction> = this.actions$.ofType(auth.ActionTypes.AUTH_LOGOUT_ERROR).do((action: UnsafeAction) => {
  //   window.localStorage.removeItem('token')
  //   this.ui.alerts.notifyError({
  //     title: get(action, 'payload.name'),
  //     body: get(action, 'payload.message'),
  ...
  //
  // @Effect({ dispatch: false })
  // logoutSuccess: Observable<UnsafeAction> = this.actions$.ofType(auth.ActionTypes.AUTH_LOGOUT_SUCCESS).do(() => {
  //   window.localStorage.removeItem('token')
  //   this.ui.alerts.notifySuccess({
  ...
  //
  // @Effect({ dispatch: false })
  // getUserInfo$ = this.actions$.ofType('AUTH_GET_USER_ROLES').do((action: UnsafeAction) => {
  ...
  //
  // @Effect({ dispatch: false })
  // checkToken: Observable<UnsafeAction> = this.actions$
  ...
  //
  // @Effect({ dispatch: false })
  // checkTokenError: Observable<UnsafeAction> = this.actions$.ofType(auth.ActionTypes.AUTH_CHECK_TOKEN_ERROR).do((action: UnsafeAction) => {
  //   this.ui.alerts.notifyError({
  //     title: 'Invalid Token',
  ...
  //
  // @Effect({ dispatch: false })
  // checkTokenSuccess: Observable<UnsafeAction> = this.actions$.ofType(auth.ActionTypes.AUTH_CHECK_TOKEN_SUCCESS).do(() => {
  //   this.ui.alerts.notifySuccess({
  //     title: 'Valid Token',
